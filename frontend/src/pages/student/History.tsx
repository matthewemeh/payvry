...
const History: React.FC<Props> = ({ history }) => {
  ...
  return (
    <main className='w-screen min-h-screen px-4 mt-14 mb-5'>
      <h1 className='text-center font-semibold text-[20px] leading-[26px]'>History</h1>

      <div className='info-bubble menu hidden bg-white w-[355px] fixed z-[1] p-[30px] pr-[102px] rounded-[30px] border-[1px] border-alto'>
      ...
      <section className='flex'>
        ...
        <div className='grid grid-cols-[20px_minmax(0,1fr)] gap-x-[5px] gap-y-2 font-medium text-[10px] leading-[17px]'>
          ...
          <button
            onClick={e => showInfo('.menu', e.clientY + 15)}
            className='border-[1px] border-alto col-start-1 col-end-3 rounded-[10px] mt-[5px] py-[5px] px-[10px] capitalize flex items-center justify-center gap-x-[5px]'
          >
            {duration}
